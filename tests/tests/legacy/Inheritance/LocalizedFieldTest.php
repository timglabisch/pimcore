...
class TestSuite_Inheritance_LocalizedFieldTest extends Pimcore_Test_Case {
    ...
    public function testInheritanceLocalizedField() {
        ...
        $two = new Object_InheritanceLocalizedField();
        $two->setKey("two");
        ...
        $three = new Object_InheritanceLocalizedField();
        $three->setKey("three");
        ...
        $list = new Object_InheritanceLocalizedField_List();
