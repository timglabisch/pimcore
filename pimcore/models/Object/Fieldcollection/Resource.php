...
class Object_Fieldcollection_Resource extends Pimcore_Model_Resource_Abstract {
    ...
    public function delete (Object_Concrete $object) {
        ...
        $this->db->delete("object_relations_" . $object->getTableNameSuffix(), "ownertype = 'fieldcollection' AND " . $this->db->quoteInto("ownername = ?", $this->model->getFieldname()) . " AND " . $this->db->quoteInto("src_id = ?", $object->getId()));
    }
}
