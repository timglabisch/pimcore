...
class Object_Objectbrick_Data_Resource extends Pimcore_Model_Resource_Abstract {
    ...
    public function save (Object_Concrete $object) {
        ...
        try {
            $this->db->delete("object_relations_" . $object->getTableNameSuffix(), "src_id = " . $object->getId() . " AND ownertype = 'objectbrick' AND ownername = '" . $this->model->getFieldname() . "' AND (position = '" . $this->model->getType() . "' OR position IS NULL OR position = '')");
        } catch(Exception $e) {
    ...
    public function delete(Object_Concrete $object) {
        ...
        $this->db->delete("object_relations_" . $object->getTableNameSuffix(), "src_id = " . $object->getId() . " AND ownertype = 'objectbrick' AND ownername = '" . $this->model->getFieldname() . "' AND position = '" . $this->model->getType() . "'");
    }
