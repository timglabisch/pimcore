 ...
 */
class Pimcore_Test_Helper_Data
{
    ...
    public static function fillImage($object, $field, $seed = 1) {
        ...
        if (!$asset) {
            $asset = Pimcore_Test_Helper_Tool::createImageAsset("", null, false);
    ...
    public static function assertHotspotImage($object, $field, $seed = 1) {
        ...
        $value = Pimcore_Test_Helper_Tool::createAssetComparisonString($value->getImage);
        $expected = Pimcore_Test_Helper_Tool::createAssetComparisonString($expected->getImage);
    ...
    public static function assertGeobounds($object, $field, $comparisonObject, $seed = 1) {
        ...
        $value = Pimcore_Test_Helper_Tool::getComparisonDataForField($field, $fd, $object);
        $expected = Pimcore_Test_Helper_Tool::getComparisonDataForField($field, $fd, $comparisonObject);
    ...
    public static function fillLink($object, $field, $seed = 1) {
        ...
        if (!$doc) {
            $doc = Pimcore_Test_Helper_Tool::createEmptyDocumentPage(null, false);
    ...
    public static function assertObjectsWithMetadata($object, $field, $comparisonObject, $seed = 1) {
        ...
        $fd = $object->getClass()->getFieldDefinition($field);
        $valueForField = Pimcore_Test_Helper_Tool::getComparisonDataForField($field, $fd, $object);
        $expected = Pimcore_Test_Helper_Tool::getComparisonDataForField($field, $fd, $comparisonObject);
