...
class Pimcore_Test_Helper_Tool
{
  ...
  */
    ...
    public static function createFullyFledgedObject($objectname, $keyPrefix = "", $save = true, $seed = 1) {
        ...
        try {
            ...
            Pimcore_Test_Helper_Data::fillHotspotImage($object, "hotspotimage", $seed);
            Pimcore_Test_Helper_Data::fillLanguage($object, "languagex", $seed);
            Pimcore_Test_Helper_Data::fillCountry($object, "country", $seed);
            Pimcore_Test_Helper_Data::fillDate($object, "date", $seed);
            Pimcore_Test_Helper_Data::fillDate($object, "datetime", $seed);
            Pimcore_Test_Helper_Data::fillTime($object, "time", $seed);
            Pimcore_Test_Helper_Data::fillSelect($object, "select", $seed);
            Pimcore_Test_Helper_Data::fillMultiSelect($object, "multiselect", $seed);
            Pimcore_Test_Helper_Data::fillUser($object, "user", $seed);
            Pimcore_Test_Helper_Data::fillCheckbox($object, "checkbox", $seed);
            Pimcore_Test_Helper_Data::fillWysiwyg($object, "wysiwyg", $seed);
            Pimcore_Test_Helper_Data::fillPassword($object, "password", $seed);
            Pimcore_Test_Helper_Data::fillMultiSelect($object, "countries", $seed);
            Pimcore_Test_Helper_Data::fillMultiSelect($object, "languages", $seed);
            Pimcore_Test_Helper_Data::fillGeopoint($object, "point", $seed);
            Pimcore_Test_Helper_Data::fillGeobounds($object, "bounds", $seed);
            Pimcore_Test_Helper_Data::fillGeopolygon($object, "poly", $seed);
            Pimcore_Test_Helper_Data::fillTable($object, "table", $seed);
            Pimcore_Test_Helper_Data::fillLink($object, "link", $seed);
            Pimcore_Test_Helper_Data::fillStructuredTable($object, "structuredtable", $seed);
            Pimcore_Test_Helper_Data::fillObjects($object, "objects", $seed);
            Pimcore_Test_Helper_Data::fillObjectsWithMetadata($object, "objectswithmetadata", $seed);
            Pimcore_Test_Helper_Data::fillInput($object, "linput", $seed, "de");
            Pimcore_Test_Helper_Data::fillInput($object, "linput", $seed, "en");
            Pimcore_Test_Helper_Data::fillObjects($object, "lobjects", $seed, "de");
    ...
    public static function cleanUp($cleanAssets = true, $cleanDocuments = true, $cleanObjects = true) {
        ...
        Pimcore::collectGarbage();
        print("    number of objects is " . Pimcore_Test_Helper_Tool::getObjectCount() . "\n");
        print("\n");
    }
